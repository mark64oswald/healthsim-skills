...
def format_scenario_saved(scenario: Any) -> str:
    ...
    lines = [
        ...
        f"- Rx Members: {scenario.get_entity_count('rx_members')}",
...
def format_scenario_list(scenarios: list[dict]) -> str:
    ...
    if not scenarios:
        return (
            ...
            "Generate some rx members and use `save_scenario` to save your work."
        )
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "name": {
                        "type": "string",
                        "description": "Name for the scenario (e.g., 'pbm-testing', 'specialty-demo')",
                        "minLength": 1,
                    },
                    "description": {
                        "type": "string",
        ...
        return [
            TextContent(
                ...
                text=(
                    ...
                    "load a scenario with `load_scenario`."
                ),
            )
        ]
